...
try:
    ...
    for i, file_path in enumerate(bit_paths):
        ...
        plt.subplot(1, 2, 1)
        plt.plot(epochs, losses, marker='o', markersize=4, linestyle='-', label=f'BitLoRA r={2**(i+2)}')
        plt.subplot(1, 2, 2)
        plt.plot(eval_epochs, eval_losses, marker='o', markersize=4, linestyle='-', label=f'BitLoRA r={2**(i+2)}')
